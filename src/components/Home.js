...
import CV from '../assets/Dawid_Salamon_CV.pdf';
    ...
    return (
        <div name="home" className="w-full h-screen bg-[#f2f2f2]">
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
                <p className="text-3xl sm:text-7xl font-bold text-[#d98014]">I warmly welcome, I am</p>
                ...
                <h2 className="text-2xl sm:text-4xl font-bold text-[#0d0d0d]">I have been learning JavaScript for two
                    years</h2>
                <h2 className="text-2xl sm:text-4xl mt-3 font-bold text-[#d98014]">I would love to become a Junior Node.js
                    Developer</h2>
